...
\begin{{itemize}}
    \item \textbf{{Przedział wiekowy:}} {najliczniejsza_grupa1[0]} \textbf{{Liczba klientów:}} {najliczniejsza_grupa1[1]}
\end{{itemize}}
\begin{{itemize}}
    \item \textbf{{Przedział wiekowy:}} {najliczniejsza_grupa2[0]} \textbf{{Liczba klientów:}} {najliczniejsza_grupa2[1]}
\end{{itemize}}

Najmniej liczne grupy wiekowe:
\begin{{itemize}}
    \item \textbf{{Przedział wiekowy:}} {najmniej_liczna_grupa1[0]} \textbf{{Liczba klientów:}} {najmniej_liczna_grupa1[1]}
\end{{itemize}}
\begin{{itemize}}
    \item \textbf{{Przedział wiekowy:}} {najmniej_liczna_grupa2[0]} \textbf{{Liczba klientów:}} {najmniej_liczna_grupa2[1]}
\end{{itemize}}
